...
logical,parameter::infinite = .false.         ! True: Infinite horizon setting; False: Finite horizon setting ending after nit iterations
...
! I Parameters
! Prices
real(prec),parameter::ret   = 0.05d0          ! Interest rate on assets
