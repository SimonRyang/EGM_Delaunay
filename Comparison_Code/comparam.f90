...
integer,parameter::age      = 40             ! number of maximal iteration steps/ number of years in finite setting
...
real(prec),parameter::curv2= 1.0              ! Curvature of auxiliar grid
...
!V Simulation
real(prec),parameter::x0min = 250.0            ! Lower bound for initial assets for simulation
real(prec),parameter::x0max = 450.0            ! Upper bound for initial assets
