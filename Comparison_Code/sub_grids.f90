...
gridhex(1:nh) = func_makegrid(minh,maxh,nh,curv2)      ! Grid for human capital in EXGM

! ENDGM
gridz(1:nh) = func_makegrid(minz,maxz,nh,curv2)        ! Grid for human capital savings 
...
! HEGM
gridhhy(1:nh) = func_makegrid(minh,maxh,nh,curv2)      ! Grid for human capital in HEGM
